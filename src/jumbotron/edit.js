...
export const edit = (props) => {
  ...
  const classNameAttribute = () => {
    const jumbotronClass = isFluid ? "jumbotron jumbotron-fluid" : "jumbotron"; 
    return [className, jumbotronClass].join(" ").trim();
  }
  ...
  return (
    <Fragment>
      ...
      <InspectorControls>
          <PanelBody
              title={ __( 'Jumbotron Settings', 'advanced-bootstrap-blocks' ) }
              initialOpen={true}
          >
            <PanelRow>
                <label
                ...
                >
                    { __( 'Full-width Jumbotron', 'advanced-bootstrap-blocks' ) }
                </label>
                <FormToggle
                    id="form-toggle-fluid"
                    label={ __( 'Full-width jumbotron', 'advanced-bootstrap-blocks' ) }
                    checked={ isFluid }
            ...
            {/* <PanelRow>
                <label
                    htmlFor="form-toggle-fluid"
                >
                    { __( 'Wrap jumbotron', 'advanced-bootstrap-blocks' ) }
                </label>
                <FormToggle
                    id="form-toggle-fluid"
